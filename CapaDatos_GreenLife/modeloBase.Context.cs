...
namespace CapaDatos_GreenLife
{
    ...
    public partial class GreenlifeEntities : DbContext
    {
        ...
        public virtual int spInsertarFactura(Nullable<int> idUsuario, Nullable<int> idCliente, Nullable<System.DateTime> fecha, string metodoDePago, Nullable<decimal> subtotal, Nullable<decimal> iva, Nullable<decimal> total)
        {
            var idUsuarioParameter = idUsuario.HasValue ?
                new ObjectParameter("idUsuario", idUsuario) :
                new ObjectParameter("idUsuario", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spInsertarFactura", idUsuarioParameter, idClienteParameter, fechaParameter, metodoDePagoParameter, subtotalParameter, ivaParameter, totalParameter);
        }
